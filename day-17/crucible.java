...
class Crucible {
    ...
    public static void main (String [] args) {
        if (args.length != 1) {
            System.out.println("usage: java Crucible [filename]");
            return;
        }
        ...
        try {
            ...
            while (queue.size() != 0) {
                ...
                if (consec != 0 && distance >= trackTable.get(xPos).get(yPos).get(3 * dir + (consec - 1))) {
                    continue;
                }

                if (consec != 0) {
                    trackTable.get(xPos).get(yPos).set(3 * dir + (consec - 1), (double)distance);
                }

                if (xPos == (numRows - 1) && yPos == (numCols - 1)) {
                ...
                switch (dir) {
                    case 0:
                        ...
                        if (consec < 3) { queue.add(Arrays.asList( new Integer[] { distance, xPos, yPos + 1, 0, consec + 1 } )); }
                        break;
                    ...
                    case 1:
                        ...
                        if (consec < 3) { queue.add(Arrays.asList( new Integer[] { distance, xPos + 1, yPos, 1, consec + 1 } )); }
                        break;
                    ...
                    case 2:
                        ...
                        if (consec < 3) { queue.add(Arrays.asList( new Integer[] { distance, xPos, yPos - 1, 2, consec + 1 } )); }
                        break;
                    ...
                    case 3:
                        ...
                        if (consec < 3) { queue.add(Arrays.asList( new Integer[] { distance, xPos - 1, yPos, 3, consec + 1 } )); }
                        break;
