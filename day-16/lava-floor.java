...
class LavaFloor {
    ...
    public static void main (String [] args) {
        if (args.length != 1) {
            System.out.println("usage: java LavaFloor [filename]");
            return;
        }
        ...
        try {
            ...
            List<Integer> queueX = new ArrayList<Integer>(); queueX.add(0);
            List<Integer> queueY = new ArrayList<Integer>(); queueY.add(0);
            List<Integer> queueDir = new ArrayList<Integer>(); queueDir.add(0);
            ...
            System.out.println("Energized sum is " + sum);
